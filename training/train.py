...
sys.path.append("/data2/seg/LM-EEC")
import traceback
...
def main(args) -> None:
    ...
    # OmegaConf.to_container 是 OmegaConf 提供的一个方法，用于将 OmegaConf 配置对象 转换成常规的 Python 数据结构（如字典、列表等）。
    cfg_resolved = OmegaConf.create(cfg_resolved)
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        "--config",
        # required=True,
        default="configs/sam2.1_training/sam2.1_hiera_b+_EgoExo_finetune.yaml",
        type=str,
